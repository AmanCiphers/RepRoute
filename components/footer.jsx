  ...
  return (
    <footer className="relative overflow-hidden border-t border-[#d9d8d2] bg-[#2f2f2d] text-white">
      <div className="pointer-events-none absolute -bottom-10 -right-10 select-none opacity-[0.04]">
        <Image src="/white_clover.svg" alt="" width={384} height={384} className="h-auto scale-200 w-auto sm:h-96" />
      </div>
      <div className="px-6 py-12 sm:px-10 lg:px-20 xl:px-28">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-2" aria-label="RepRoute home">
              ...
              <span>x</span>
              <Image src="/white_clover.svg" alt="" width={32} height={32} className="h-8 w-auto" />
            </Link>
        ...
        <div className="mt-12 border-t border-white/15 pt-8">
          <p className="text-sm font-semibold text-white/50">
            {new Date().getFullYear()} RepRoute — A <span className="font-bold underline"><a target="_blank" rel="noreferrer" href="https://cloverforge.vercel.app/">CloverForge</a></span> product. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
